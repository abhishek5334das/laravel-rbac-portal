            ...
            <tbody>
                @foreach ($users as $place)
                    <tr>
                        ...
                        <td>
                            @if($place->role == 'user')
                                <a href="{{ route('user.edit', $place->id) }}" class="btn btn-success">Edit</a>
                                <form action="{{ route('user.delete', $place->id) }}" method="POST" style="display:inline-block;" class="delete-form">
                                    @csrf
                                    @method('DELETE')
